...
/// A subsystem for reading errors that may occur during an attempt
/// to retrieve a list of user's favorite geographic places data.
class GetAllFavoritePlacesErrors extends Errors
{
